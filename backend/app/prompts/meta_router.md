...
- **키워드**: 대시보드, 차트, 리포트, 통계, 그래프, 추이, 카드 추가, 카드 삭제, 지표 추가, 지표 삭제, 카드 만들어, **비타민, 미네랄, 원료, 성분, 배합비, 정제, 캡슐, 시럽, 제형, 한국바이오팜**
- **용도**: 데이터 분석, 차트 생성, **대시보드 카드(StatCard) 관리**, **한국바이오팜 배합비 데이터 조회**
- **예시**:
  - "지난 주 생산량을 차트로 보여줘"
  - "불량률 추이를 분석해줘"
  - "불량률 카드 추가해줘"
  - "생산량 지표 카드 만들어줘"
  - "효율성 카드 삭제해줘"
  - **"비타민C를 포함한 제품 찾아줘"** → **bi** (한국바이오팜 데이터)
  - **"정제 제품 10개 보여줘"** → **bi** (한국바이오팜 데이터)
  - **"배합비 데이터 분석해줘"** → **bi** (한국바이오팜 데이터)
...
- **"비타민", "미네랄", "원료", "성분", "배합비", "정제", "캡슐", "시럽", "제형", "한국바이오팜", "바이오팜" 언급 시** → **bi** (한국바이오팜 데이터 조회)
...
### ✅ bi로 라우팅해야 하는 예시 (시각화/분석 요청 + 한국바이오팜 데이터)
- "11월달 센서 데이터를 **차트로** 보여줘" → **bi** (시각화 명시)
- "온도 **추이 그래프** 만들어줘" → **bi**
- "라인별 불량률 **비교** 대시보드" → **bi**
- "지난달 생산량 **통계 분석**해줘" → **bi**
- "센서 데이터 **시각화**해줘" → **bi**
- **"비타민C를 포함한 제품 찾아줘"** → **bi** (한국바이오팜 데이터 조회)
- **"정제 제품 10개 보여줘"** → **bi** (한국바이오팜 데이터)
- **"배합비 데이터 분석"** → **bi** (한국바이오팜 데이터)
- **"제형별 제품 수"** → **bi** (한국바이오팜 통계)
