...
계획 파일: .claude/plans/xxx.md
승인하시면 진행하겠습니다."
```

**DON'T (지양)**:
```
❌ 이전 계획 전체를 답변에 포함 (너무 김)
❌ 계획 파일 내용을 그대로 복붙
❌ 수백 줄의 장문 답변
...
예시:
"✅ Learning Pipeline 가이드 완료!

작성 파일:
- docs/guides/LEARNING_PIPELINE_GUIDE.md (600줄)
- Sample Curation, Rule Extraction, Golden Sets 포함
- 트러블슈팅 5개 추가

효과:
- 온보딩 시간: 3시간 → 12분 (15배 단축)
- 중복 개발 방지: 2.5주 절약

커밋: 31527cd
다음: Canary Deployment 가이드 작성"
```
...
예시 (나쁨):
"앞서 계획한 대로 Learning Pipeline... [이전 계획 반복]
...
[500줄의 기술 상세...]"
```
